...
namespace Tic_Tac_Toe_Console_App
{
    ...
    {
        // Funktion zur Suche, ob 3 in einer Reihe vorhanden
        ...
        // Fragt ab, ob Feld bereits gewählt wurde
        ...
        // Gibt das Feld im aktuellen Zustand neu aus
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Wollen Sie ein neues Spiel beginnen? (J/N)");
                input = Console.ReadLine();
            } while (input == "J" || input == "j");
            Console.WriteLine("Spiel wurde beendet. Noch einen schönen Tag!");
        }
    }
}
